...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-y-auto bg-slate-950 px-3 py-6 sm:p-6 lg:p-8 font-sans selection:bg-brand-500 selection:text-white">
      ...
      {/* ── High-Tech AI Background Artwork (login1.jpeg) ── */}
      <div 
      ...
      {/* ── Main Responsive Card (Native Mobile App Feel on Phones + Glass Floating Card on Desktop) ── */}
          ...
          <div className="mb-6 sm:mb-7 flex flex-col items-center text-center">
            <div className="relative mb-3.5 sm:mb-4 group">
              ...
              <img
                ...
                alt="Company Logo"
                className="relative h-16 w-16 sm:h-20 sm:w-20 rounded-2xl object-cover shadow-2xl border border-white/30 bg-slate-950 transition-transform duration-300 group-hover:scale-105"
              />
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative group">
                <Mail className="absolute left-3.5 top-3.5 sm:top-4 h-4.5 w-4.5 text-slate-400 group-focus-within:text-brand-400 transition-colors pointer-events-none" />
                <input
                  type="email"
            ...
            <div>
              ...
              <div className="relative group">
                <Lock className="absolute left-3.5 top-3.5 sm:top-4 h-4.5 w-4.5 text-slate-400 group-focus-within:text-brand-400 transition-colors pointer-events-none" />
                <input
        ...
        <div className="mt-6">
          <div className="text-center">
            <p className="text-xs sm:text-sm text-slate-300">
              ...
              <Link to="/signup" className="font-extrabold text-brand-400 hover:text-brand-300 hover:underline transition-colors">
                Create Account
              </Link>
            </p>
          </div>
          ...
          <div className="mt-5 flex items-center justify-center gap-1.5 text-[10px] sm:text-[11px] font-bold text-slate-400 uppercase tracking-widest pt-4 border-t border-white/10">
            ...
            <span>256-Bit Encrypted Multi-Tenant Portal</span>
          </div>
        </div>
      </div>
    </div>
